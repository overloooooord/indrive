...
urlpatterns = [
    ...
    path('admin/applications/clear/', views.admin_delete_all_applications, name='admin-delete-all-applications'),
    path('admin/applications/<int:pk>/score/', views.admin_score_application, name='admin-score-application'),
    path('admin/applications/<int:pk>/delete/', views.admin_delete_application, name='admin-delete-application'),
